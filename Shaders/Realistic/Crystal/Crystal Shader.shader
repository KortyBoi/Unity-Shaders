//Shader Created by Kortana with help of Shader Forge
//Kortana#4110 | http://kortana.xyz/ 

Shader "Kortana/Crystal Shader" {
    Properties {
        _BaseColortex ("Base Color Texture", 2D) = "white" {}
        [HDR]_BasaColor ("Base Color", Color) = (1,1,1,1)
        _SurfaceClolrtex ("Surface Color Texture", 2D) = "white" {}
        _SurfaceClolr ("Surface Color", Color) = (0,0,0,1)
        _Normal ("Normal Map", 2D) = "bump" {}
        [HideInInspector]_alpha ("Alpha", 2D) = "white" {}
        _Metallic ("Metallic", Range(0, 1)) = 0.3
        _Gloss ("Gloss", Range(0, 1)) = 0.67
        _Repetition ("Repetition", Range(1, 20)) = 10
        _ColorLoop ("ColorLoop", Range(1, 5)) = 1
        _Width ("Width", Range(0, 1)) = 0.5
        _ColoeLevel ("Coloe Level", Range(0, 1)) = 0.2
        _PasutelColor ("Pasutel Color", Range(0, 1)) = 0.3
        _Distortion ("Distortion", Range(0, 15)) = 5
        _ChromaticAberration ("Chromatic Aberration", Range(-1.01, 1.01)) = 0
		[HideInInspector] _MainTex("Base (RGB)", 2D) = "white" {}
		[HideInInspector] _ReflectionTex0("", 2D) = "white" {}
		[HideInInspector] _ReflectionTex1("", 2D) = "white" {}
        [HideInInspector][MaterialToggle] _LightCompletion ("Light Completion", Float ) = 1
